function [Fx, Fy] = sobel_xy(input_image)
    ...
    % Faltung der Bilddaten mit dem Sobelfilter: Um den Rand werden Nullen ergänzt,
    % damit auch die äußeren Pixel einen äußeren Nachbarn für den entsprechenden Koeffizienten in der Filtermatrix haben.
