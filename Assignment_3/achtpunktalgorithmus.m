function EF = achtpunktalgorithmus(Korrespondenzen, K)
    ...
    % Die rechte Spalte von V ist das Ergebnis des Minimierungsproblems Gs = argmin (||A * EFs||²) über EFs mit EFs als vektorisierter Form der EF-Matrix (essenzielle oder Fundamentalmatrix, je nachdem, ob mit justierten Bildkoordinaten gearbeitet wurde) und Gs als geschätzter EF-Matrix in vektorisierter Form.
